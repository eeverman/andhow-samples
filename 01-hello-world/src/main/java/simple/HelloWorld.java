 ...
 * Properties are <em>constants</em>, thus, they are always {@code static final}, but may be
 * {@code private} or any scope.
 ...
 * <p>
 * The Properties in the example have defaults, so no further configuration is needed:
...
public class HelloWorld {
	...
	private static final StrProp NAME = StrProp.builder()
			.defaultValue("Dave").build();
		
	public static final IntProp REPEAT_COUNT = IntProp.builder()
